...
// Read process.env directly: this module runs on Railway too, where some
// schema-required vars (REPLICATE_MODEL_*) aren't set. getServerEnv() would
// throw "Invalid server environment variables" mid-request. Schema entry in
// src/lib/env.ts is kept for documentation.
