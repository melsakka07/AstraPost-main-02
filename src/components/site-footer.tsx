            ...
            <div className="flex items-center gap-2 pt-1" aria-label="Social media links">
              {SOCIAL_LINKS.map(({ label, href, Icon }) => (
                <Link
                  ...
                  aria-label={label}
                  className="border-border/60 bg-background text-muted-foreground hover:border-primary/40 hover:bg-primary/5 hover:text-foreground flex h-9 w-9 items-center justify-center rounded-lg border transition-all duration-200"
                >
