...
async function getMetrics() {
  ...
  // Total Users
  const [totalUsers] = await db.select({ count: count(user.id) }).from(user);
...
export default async function MetricsPage() {
  ...
  return (
    <AdminPageWrapper
      icon={BarChart}
      title="Metrics"
      description="Signups, subscriptions, and job activity."
    >
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-muted-foreground text-xs">Estimated from active subscriptions</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-muted-foreground text-xs">Processed in last 24 hours</p>
            </CardContent>
          </Card>
        </div>
