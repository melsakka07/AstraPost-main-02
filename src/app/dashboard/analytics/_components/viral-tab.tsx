...
/**
 * ViralTab — extracted body of the former `/dashboard/analytics/viral` page.
 * Now rendered as a tab inside the Analytics hub. The standalone route still
 * exists as a thin redirect for any external links.
 */
export function ViralTab() {
  ...
  return (
    <div className="space-y-6">
      {/* Tab-local toolbar (replaces page-level `actions` slot) */}
