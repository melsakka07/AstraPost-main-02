...
export async function GET() {
  const sessionResult = await withTimeout(auth.api.getSession({ headers: await headers() }), API_TIMEOUT_MS);
  ...
  const notificationsResult = await withTimeout(db.query.notifications.findMany({
