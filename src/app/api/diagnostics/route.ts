...
export async function GET(req: Request) {
  const env = {
    ...
    TWITTER_CLIENT_ID: Boolean(process.env.TWITTER_CLIENT_ID),
    TWITTER_CLIENT_SECRET: Boolean(process.env.TWITTER_CLIENT_SECRET),
  ...
  const authConfigured =
    env.BETTER_AUTH_SECRET && env.TWITTER_CLIENT_ID && env.TWITTER_CLIENT_SECRET;
