      ...
      <div className="container mx-auto px-4 py-16 md:py-24 space-y-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-card border rounded-xl p-8 hover:-translate-y-1 hover:shadow-lg transition-all duration-200">
        ...
        {/* CTA */}
        <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-gradient-to-br from-muted/50 to-muted/20 p-8 md:p-12 text-center shadow-lg">
          <div className="absolute inset-0 bg-gradient-to-br from-primary/8 via-purple-500/6 to-pink-500/8" />
