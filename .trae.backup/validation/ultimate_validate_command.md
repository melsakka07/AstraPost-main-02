...
Analyze this codebase deeply and create `validation/validate.md` that comprehensively validates everything.
...
Write the generated validation command to `.validation/validate.md`
