...
> **Generated from `src/lib/schema.ts` (1833 lines, verified 2026-07-07). 47 tables, 17 enums, 90 migrations.**
...
| 47  | `inboxItems`             | id, userId, xAccountId, type (mention/reply/quote), sourceTweetId, sourceAuthorId, sourceAuthorHandle, sourceAuthorName, sourceAuthorAvatarUrl, sourceText, yourTweetId, yourTweetText, isRead, isArchived, isReplied, aiReplied, xCreatedAt, createdAt | 1794-1833   |
...
_All table definitions verified against `src/lib/schema.ts` on 2026-07-07. For the full Drizzle schema with relations, indexes, and triggers, see the source file._
