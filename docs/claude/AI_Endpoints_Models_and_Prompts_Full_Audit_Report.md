...
- **Worker-side AI** — verified that `src/lib/queue/processors.ts` makes zero AI calls; all generation is request-time.
...
### Text Models (OpenRouter) — `src/lib/env.ts:23-34`
