...
export const TONE_ENUM = z.enum(["professional", "casual", "educational", "inspirational", "humorous", "viral", "controversial"]);
```
...
export const ApiError = {
  ...
  badRequest: (issues: ZodIssue[]) => Response.json({ error: "Validation failed", issues }, { status: 400 }),
...
*Document maintained at `docs/audit/backend-redundancy-audit.md`*
