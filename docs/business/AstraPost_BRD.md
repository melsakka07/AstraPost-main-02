...
> _"Within 12 months of launch, AstraPost becomes the #1 Arabic-native X scheduling tool in the MENA region — serving 10,000 active users with $25,000 MRR."_
...
> _As a new user, I want to connect my X account with one click so that I can start scheduling without any technical complexity._
...
> _As a new user, I want to be guided through the setup so that I understand how to use AstraPost immediately._
...
> _As a content creator, I want to write a tweet and schedule it for tomorrow at 9am so that it publishes while I'm sleeping._
...
> _As a content creator, I want to create a 7-tweet thread so that I can publish long-form content on X._
...
> _As a creator, I want to attach an image and a GIF to my tweet so that it stands out in the feed._
...
> _As a Pro user, I want to input "productivity tips for Arabic students" and get a 5-tweet thread so that I save 30 minutes of writing._
...
> _As an affiliate marketer, I want to paste an Amazon product URL and get a ready-to-post promotional tweet with my affiliate link._
...
> _As a Pro user, I want to see how my tweets performed so that I know what content resonates with my audience._
...
> _As a social media manager, I want to export a 30-day analytics report as PDF so that I can share it with my client._
...
> _As a Free user, I want to upgrade to Pro so that I can schedule unlimited tweets and use the AI features._
...
### 11.5 Analytics Screen `/analytics` _(Pro Only)_
...
### 11.6 AI Writer Screen `/ai-writer` _(Pro Only)_
...
_Target: New users, students, casual creators_
...
_Target: Active content creators, influencers, solo marketers_
...
_Target: Committed creators, cost-conscious users_
...
#### 🏢 Agency Plan — $79/month _(Phase 2)_

_Target: Digital agencies, freelancers managing multiple clients_
...
_© 2026 AstraPost. All rights reserved. This document is confidential and intended for internal use only._
