...
- **Problem:** User pastes a URL and clicks Generate, but doesn't see the tweet content until _after_ generation completes. If they pasted the wrong URL, they wasted an AI credit.
...
```tsx
<Button
  onClick={() => sendToComposer(data.tweets, { source: "ai-writer", tone })}
  variant="default"
>
